...
> Я создал 1 000 000 документов и сравнил скорость поиска по author без индекса | с индексом. Время запроса ускорилось в 25 раз, прилагаю скрины с запросом и его планом выполнения.
